...
import { catchError, switchMap, filter, take, subscribeOn, finalize } from "rxjs/operators";
            ...
            if (error.status === 401) {
              ...
              if (error.error.error == 'invalid_token') {
                ...
                if (environment.production) {
                  ...
                  let url = error.url;
                  this.myAlert('ERROR: 401',
                    'Te jodiste chee no tenes permiso para el siguiente servicio: ' +
                    url + ' | Reportelo junto con una captura de network a quien hizo este componente (mensaje solo en desa)'
                  );
                }
